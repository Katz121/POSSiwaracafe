    ...
    const handleConsultantQuery = async () => {
        ...
        try {
            ...
            const systemPrompt = `
                ...
                ข้อมูลร้านเดือนนี้ (${currentMonth}):
        ...
        <div className="h-full bg-[#f8faf9] flex flex-col animate-in fade-in duration-700 overflow-hidden text-gray-800 relative">
            ...
            <header className="h-24 bg-white border-b border-gray-100 px-12 flex items-center justify-between shadow-sm z-10 shrink-0">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div className="bg-white border-2 border-emerald-100 flex items-center gap-3 px-6 py-3 rounded-2xl shadow-sm text-emerald-600 font-black uppercase text-xs tracking-widest leading-none shrink-0">
                        <Calendar size={18} /> {new Date().toLocaleDateString('th-TH', { month: 'long', year: 'numeric' })}
                    </div>
