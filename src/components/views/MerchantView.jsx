...
export default function MerchantView() {
  ...
  return (
    <div className="h-full bg-gray-950 text-white flex flex-col overflow-hidden"> {/* Kitchen Display System: intentionally always dark for kitchen environments */}
      <header className="h-16 md:h-20 lg:h-24 border-b border-gray-800/50 flex justify-between items-center px-4 md:px-8 lg:px-12 bg-gray-900 shadow-2xl z-[10]">
        ...
        <div className="text-right flex items-center gap-4 md:gap-8 lg:gap-12 text-gray-300">
          <div className="border-r border-gray-800 pr-4 md:pr-8 lg:pr-12 text-right hidden md:block">
            <p className="text-xs md:text-xs text-gray-500 uppercase tracking-widest font-black mb-1 md:mb-2">รายได้วันนี้</p>
